...
export const metadata: Metadata = {
  title: 'Luma Proxys — Proxys Premium Residencial',
  description: 'Proxys residenciais, móveis e datacenter em +180 países. Setup em segundos, pague só pelo que usar.',
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="pt-BR">
      ...
      }}><AuthSync /><Cursor /><Toaster />{children}</body>
    </html>
  )
}
